...
import { getGenerativeModel as getGenerativeModel$1, getImagenModel as getImagenModel$1, getVertexAI as getVertexAI$1 } from 'firebase/vertexai';
...
export { VertexAI, VertexAIInstances, VertexAIModule, getGenerativeModel, getImagenModel, getVertexAI, provideVertexAI, vertexAIInstance$ };
